                    ...
                    <div class="card-body">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <img src="" alt="pictures" v-if="file_path">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-5">
                                ...
                                <!--                                <router-link-->
                                <!--                                        :to="{ path: '/partner-bill-services/'+laravelData.id}"-->
    ...
    export default {
        ...
        mounted() {
            ...
            saveForm() {
                ...
                // this.laravelData.append('image', this.file);
                // }
                AppAxios.header().post(this.actionUrl, formData)
                    .then(response => {
